...
# Create sellers
Seller.create(name: 'Seller 1', email: 'seller1@example.com', location: 'County 1', phone_number: '123456789', password: 'password123')
Seller.create(name: 'Seller 2', email: 'seller2@example.com', location: 'County 2', phone_number: '987654321', password: 'password456')

# Create products associated with sellers
seller1 = Seller.find_by(name: 'Seller 1')
...
seller2 = Seller.find_by(name: 'Seller 2')
